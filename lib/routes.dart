...
import 'package:milk_tracker/features/home/home_screen.dart';
...
GoRouter createRouter() {
  return GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/dashboard',
        builder: (context, state) => DashboardScreen(child: const HomeScreen()),
      ),
      GoRoute(
        path: '/months',
        builder: (context, state) =>
            DashboardScreen(child: const MonthListScreen()),
      ),
      GoRoute(
        path: '/daily',
        builder: (context, state) => DashboardScreen(
          child: DailyEntryScreen(
            monthId: state.uri.queryParameters['m'] ?? '',
          ),
        ),
      ),
      GoRoute(
        path: '/today',
        builder: (context, state) =>
            DashboardScreen(child: const TodayScreen()),
      ),
      ...
      GoRoute(
        path: '/',
        builder: (ctx, state) => DashboardScreen(child: const HomeScreen()),
      ),

      GoRoute(
        path: '/months/add',
        builder: (ctx, state) => const AddEditMonthScreen(),
      ),
      GoRoute(
        path: '/months/:id',
        builder: (ctx, state) {
